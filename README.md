...
[`mutable-spec`](https://github.com/bishabosha/flagged/tree/mutable-spec) branch — the development
...
API. Make changes on `mutable-spec` and re-derive them with `mill deriveStable` rather than
