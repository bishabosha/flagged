...
class ValueParserSuite extends munit.FunSuite:
  ...
  test("map/emap combinators") {
    given portParser: Parser.Aux[Int, Parser.Shape.Value] = Parser.of[Int]("port")(s =>
      s.toIntOption match
  ...
  test("flag shape is pluggable via Parser.flag") {
    enum Volume:
      case Quiet, Loud
    given Parser.Aux[Volume, Parser.Shape.Flag] =
  ...
  test("a flag reader can bound the occurrence count") {
    ...
    given Parser.Aux[Verbosity, Parser.Shape.Flag] =
  ...
  test("any type can opt into repeated shape via Parser.repeated") {
    given Parser.Aux[Set[String], Parser.Shape.Repeated] =
  ...
  test("a repeated reader can require at least one occurrence") {
    ...
    given Parser.Aux[AtLeastOne, Parser.Shape.Repeated] = Parser.repeated[Int, AtLeastOne](l =>
  ...
  test("emap composes over a repeated reader") {
    given Parser.Aux[Int, Parser.Shape.Value] =
      Parser.of[Int]("int")(s => s.toIntOption.fold(Err(s"'$s' not an int"))(Ok(_)))
    given Parser.Aux[List[Int], Parser.Shape.Repeated] =
      Parser
